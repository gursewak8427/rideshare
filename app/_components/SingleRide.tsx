...
const SingleRide = ({ details }: any) => {
  ...
  return (
    <>
    <Link href={`/ridedetails/${details?._id}`}> <div className="w-100 p-2 flex gap-3 rounded-xl bg-gray-200">
        <div className="w-[90%]">
          ...
          <p className="mt-8 text-xs font-bold text-gray-600">
            {details?.carModel}
            <span className="text-black">&#183;</span> {details?.seats} seats available
          </p>
        </div>
